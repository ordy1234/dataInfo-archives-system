...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%">
    ...
    <div class="jumbotron text-center">
        <h1>คลังเก็บข้อมูลและสารสนเทศ</h1> <br>
        <h1> โรงเรียนอนุบาลเมืองใหม่สุวรรณภูมิ</h1>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                <a href="คู่มือการใช้งาน">คู่มือการใช้งาน</a>
            </div>

            <div class="col-sm-4">
            <span><a href="ติดต่อเรา">ติดต่อเรา</a> </span>
            </div>
    ...
    <div style="font-size:20px; text-align:left;">
        ...
        <br><select>
            ...
            <option value="Choice1"> 01.หลักสูตรการศึกษาปฐมวัย พุทธศักราช 2560 </option>
            <option value="Choice2"> 02.หลักสูตรห้องเรียนพิเศษ มอนเตสซอรี่ </option>
            <option value="Choice3"> 03.คู่มือการจัดประสบการณ์ </option>

            <option value="Choice4"> 04.แผนงาน / โครงการ </option>
            <option value="Choice5"> 05.รายงานการประเมินตนเอง (SAR) ระดับสถานศึกษา </option>
            <option value="Choice6"> 06.รายงานการประเมินตนเอง (SAR) ระดับบุคลากรครู </option>
            <option value="Choice7"> 07.แบบข้อตกลงในการพัฒนาการ อ.PA </option>
            <option value="Choice8"> 08.แบบนายผลการดำเนินงานการพัฒนางานตามข้อตกลง </option>
            <option value="Choice9"> 09.แผนการเรียนการจัดประสบการณ์ </option>

            <option value="Choice10"> 10.โครงการบ้านนักวิทยาศาสตร์น้อย </option>

            <option value="Choice11"> 11.การประเมินพัฒนาการเด็กอนุบาล 3 </option>

            <option value="Choice12"> 12.แบบคำร้องขอ </option>

            <option value="Choice13"> 13.ใบงานเสริมทักษะ </option>
...
<div>
    ...
    <div style="font-size:20px; text-align:left;">
        <a href="01.หลักสูตรการศึกษาปฐมวัย พุทธศักราช 2560">01.หลักสูตรการศึกษาปฐมวัย พุทธศักราช 2560</a>
